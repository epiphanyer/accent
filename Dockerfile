...
RUN pip install --no-deps torch==2.3.0+cu118 torchvision torchaudio --use-deprecated=legacy-resolver  --no-cache-dir -f https://mirrors.aliyun.com/pytorch-wheels/cu118
